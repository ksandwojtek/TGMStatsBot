    ...
    async def help(self, ctx: commands.context):
        if ctx.channel.id == self.global_variables.config['bot']['channel']:
            async with ctx.typing():
                            ...
                            page2.set_footer(text='Bot Created by ksndq#8052 and LordofLightning', icon_url="https://cdn.discordapp.com/avatars/431703739913732097/013868d08ceb35bf90fb568bfbd1e854.png?size=64")
        else:
